...
import net.murfgames.murftweaks.enchantment.PersistentHelper;
import net.murfgames.murftweaks.handshake.ServerHandshake;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class MurfTweaks implements ModInitializer {
	...
	public void onInitialize() {
        ...
        MurfTweaks.LOGGER.info("Murf is ready to Smurf");
	}
}